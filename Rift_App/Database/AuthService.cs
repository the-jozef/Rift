    ...
    public class AuthService
    {
        ...
        out string errorMessage)
        {
            ...
            try
            {
                ...
                string checkSql =
                "SELECT COUNT(*) FROM Users WHERE Username = @u OR SteamId64 = @s";
            ...
            string sql =
            "INSERT INTO Users (Username, PasswordHash, SteamId64) " +
            "VALUES (@u, @h, @s)";
        ...
        out string errorMessage)
        {
            ...
            "SELECT PasswordHash, SteamId64 FROM Users WHERE Username = @u";
                using var cmd = new SqliteCommand(sql, connection);
                cmd.Parameters.AddWithValue("@u", username);
