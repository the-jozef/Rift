...
namespace Rift_App.Services
{
    ...
    public static class SteamInstallService
    {
        ...
        private static readonly Dictionary<int, string> SupplementGames = new()
{
    { 2507950, "Delta Force" },
    ...
    { 1172470, "Apex Legends" },
        ...
        public static List<GameModel> GetSubscribedFreeGames(Dictionary<int, string> steamSpyGames)
        {
            var result = new List<GameModel>();
            try
            {
                // Spoj SteamSpy + supplement
                var combined = new Dictionary<int, string>(steamSpyGames);
                foreach (var kvp in SupplementGames)
